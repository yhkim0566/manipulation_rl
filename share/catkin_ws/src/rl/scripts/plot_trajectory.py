...
def main():
    ...
    fig.suptitle('Obstacle avoidance', fontsize=14)
    ...
    ax1.plot_surface(x2, y2, z2, color='g')
    ax1.plot_surface(x3, y3, z3, color='b')
    ax1.plot_surface(x4, y4, z4, color='y')
    ...
    ax1.plot(np.asarray(dataset5['real_cur_pos'])[65:135,0],np.asarray(dataset5['real_cur_pos'])[65:135,1],np.asarray(dataset5['real_cur_pos'])[65:135,2], lw=3, label='naive(horizon1)',color='r')
    ax1.plot(np.asarray(dataset6['real_cur_pos'])[65:125,0],np.asarray(dataset6['real_cur_pos'])[65:125,1],np.asarray(dataset6['real_cur_pos'])[65:125,2], lw=3, label='deriv(horizon1)',color='g')
    ax1.plot(np.asarray(dataset7['real_cur_pos'])[65:135,0],np.asarray(dataset7['real_cur_pos'])[65:135,1],np.asarray(dataset7['real_cur_pos'])[65:135,2], lw=3, label='naive(horizon5)',color='b')
    ax1.plot(np.asarray(dataset8['real_cur_pos'])[65:135,0],np.asarray(dataset8['real_cur_pos'])[65:135,1],np.asarray(dataset8['real_cur_pos'])[65:135,2], lw=3, label='deriv(horizon5)',color='y')
    ...
    ax2.plot_surface(x4, y4, z4, color='y')
    ...
    ax2.plot(np.asarray(dataset5['real_cur_pos'])[60:123,0],np.asarray(dataset5['real_cur_pos'])[60:123,1],np.asarray(dataset5['real_cur_pos'])[60:123,2], lw=3, label='naive(horizon1)',color='r')
    ax2.plot(np.asarray(dataset6['real_cur_pos'])[60:123,0],np.asarray(dataset6['real_cur_pos'])[60:123,1],np.asarray(dataset6['real_cur_pos'])[60:123,2], lw=3, label='deriv(horizon1)',color='g')
    ax2.plot(np.asarray(dataset7['real_cur_pos'])[60:123,0],np.asarray(dataset7['real_cur_pos'])[60:123,1],np.asarray(dataset7['real_cur_pos'])[60:123,2], lw=3, label='naive(horizon5)',color='b')
    ax2.plot(np.asarray(dataset8['real_cur_pos'])[60:123,0],np.asarray(dataset8['real_cur_pos'])[60:123,1],np.asarray(dataset8['real_cur_pos'])[60:123,2], lw=3, label='deriv(horizon5)',color='y')
    ...
    ax3.plot_surface(x2, y2, z2, color='g')
    ax3.plot_surface(x3, y3, z3, color='b')
    ax3.plot_surface(x4, y4, z4, color='y')
    ...
    ax3.plot(np.asarray(dataset5['real_cur_pos'])[:,0],np.asarray(dataset5['real_cur_pos'])[:,1],np.asarray(dataset5['real_cur_pos'])[:,2], lw=3, label='naive(horizon1)',color='r')
    ax3.plot(np.asarray(dataset6['real_cur_pos'])[:,0],np.asarray(dataset6['real_cur_pos'])[:,1],np.asarray(dataset6['real_cur_pos'])[:,2], lw=3, label='deriv(horizon1)',color='g')
    ax3.plot(np.asarray(dataset7['real_cur_pos'])[:,0],np.asarray(dataset7['real_cur_pos'])[:,1],np.asarray(dataset7['real_cur_pos'])[:,2], lw=3, label='naive(horizon5)',color='b')
    ax3.plot(np.asarray(dataset8['real_cur_pos'])[:,0],np.asarray(dataset8['real_cur_pos'])[:,1],np.asarray(dataset8['real_cur_pos'])[:,2], lw=3, label='deriv(horizon5)',color='y')
    plt.legend(fontsize=15)
    
    ax4 = fig.add_subplot(2,3,5, projection='3d')
    ax4.set_title('part of trajectory (view1)', fontsize=14)
    ax4.set_xlabel('x')
    ax4.set_ylabel('y')
    ax4.set_zlabel('z')
    ax4.view_init(30, 30)
    ...
    ax4.plot_surface(x2, y2, z2, color='g')
    ax4.plot_surface(x3, y3, z3, color='b')
    ax4.plot_surface(x4, y4, z4, color='y')
    ...
    ax4.plot(np.asarray(dataset1['real_cur_pos'])[65:135,0],np.asarray(dataset1['real_cur_pos'])[65:135,1],np.asarray(dataset1['real_cur_pos'])[65:135,2], lw=3, label='naive(horizon1)',color='r')
    ax4.plot(np.asarray(dataset2['real_cur_pos'])[65:125,0],np.asarray(dataset2['real_cur_pos'])[65:125,1],np.asarray(dataset2['real_cur_pos'])[65:125,2], lw=3, label='deriv(horizon1)',color='g')
    ax4.plot(np.asarray(dataset3['real_cur_pos'])[65:135,0],np.asarray(dataset3['real_cur_pos'])[65:135,1],np.asarray(dataset3['real_cur_pos'])[65:135,2], lw=3, label='naive(horizon5)',color='b')
    ax4.plot(np.asarray(dataset4['real_cur_pos'])[65:130,0],np.asarray(dataset4['real_cur_pos'])[65:130,1],np.asarray(dataset4['real_cur_pos'])[65:130,2], lw=3, label='deriv(horizon5)',color='y')
    
    ax5 = fig.add_subplot(2,3,6, projection='3d')
    ax5.set_title('part of trajectory (view2)', fontsize=14)
    ax5.set_xlabel('x')
    ax5.set_ylabel('y')
    ax5.set_zlabel('z')
    ...
    ax5.plot_surface(x2, y2, z2, color='g')
    ax5.plot_surface(x3, y3, z3, color='b')
    ax5.plot_surface(x4, y4, z4, color='y')
    ...
    ax5.plot(np.asarray(dataset1['real_cur_pos'])[60:125,0],np.asarray(dataset1['real_cur_pos'])[60:125,1],np.asarray(dataset1['real_cur_pos'])[60:125,2], lw=3, label='naive(horizon1)',color='r')
    ax5.plot(np.asarray(dataset2['real_cur_pos'])[60:118,0],np.asarray(dataset2['real_cur_pos'])[60:118,1],np.asarray(dataset2['real_cur_pos'])[60:118,2], lw=3, label='deriv(horizon1)',color='g')
    ax5.plot(np.asarray(dataset3['real_cur_pos'])[60:125,0],np.asarray(dataset3['real_cur_pos'])[60:125,1],np.asarray(dataset3['real_cur_pos'])[60:125,2], lw=3, label='naive(horizon5)',color='b')
    ax5.plot(np.asarray(dataset4['real_cur_pos'])[60:125,0],np.asarray(dataset4['real_cur_pos'])[60:125,1],np.asarray(dataset4['real_cur_pos'])[60:125,2], lw=3, label='deriv(horizon5)',color='y')
    
    ax6 = fig.add_subplot(2,3,4, projection='3d')
    ax6.set_title('Whole trajectory (with obstacle cost)', fontsize=14)
    ax6.set_xlabel('x')
    ax6.set_ylabel('y')
    ax6.set_zlabel('z')
    ax6.view_init(60, 330)
    ax6.plot_surface(x1, y1, z1, color='r')
    ax6.plot_surface(x2, y2, z2, color='g')
    ax6.plot_surface(x3, y3, z3, color='b')
    ax6.plot_surface(x4, y4, z4, color='y')
    ...
    ax6.plot(np.asarray(dataset1['real_cur_pos'])[:,0],np.asarray(dataset1['real_cur_pos'])[:,1],np.asarray(dataset1['real_cur_pos'])[:,2], lw=3, label='naive(horizon1)',color='r')
    ax6.plot(np.asarray(dataset2['real_cur_pos'])[:,0],np.asarray(dataset2['real_cur_pos'])[:,1],np.asarray(dataset2['real_cur_pos'])[:,2], lw=3, label='deriv(horizon1)',color='g')
    ax6.plot(np.asarray(dataset3['real_cur_pos'])[:,0],np.asarray(dataset3['real_cur_pos'])[:,1],np.asarray(dataset3['real_cur_pos'])[:,2], lw=3, label='naive(horizon5)',color='b')
    ax6.plot(np.asarray(dataset4['real_cur_pos'])[:,0],np.asarray(dataset4['real_cur_pos'])[:,1],np.asarray(dataset4['real_cur_pos'])[:,2], lw=3, label='deriv(horizon5)',color='y')
