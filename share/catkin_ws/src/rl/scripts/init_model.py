        ...
        for i in range(epoch):
            if self.deriv:
                feed_dict = {self.pose:train_data['real_cur_pos'],
                             self.vel:train_data['real_cur_vel'],
                             self.desired_acc:train_data['desired_cur_acc'],
                             self.next_pose:train_data['real_next_pos'],
                             self.next_vel:train_data['real_next_vel'],
                             self.desired_next_acc:train_data['desired_next_acc'],
                             self.desired_next_pose:train_data['desired_next_pos'],
    ...
    def evaluation(self, eval_data):
        ...
        if self.deriv:
            feed_dict ={self.pose:eval_data['real_cur_pos'],
                        self.vel:eval_data['real_cur_vel'],
                        self.desired_acc:eval_data['desired_cur_acc'],
                        self.next_pose:eval_data['real_next_pos'],
                        self.next_vel:eval_data['real_next_vel'],
                        self.desired_next_acc:eval_data['desired_next_acc'],
                        self.desired_next_pose:eval_data['desired_next_pos'],
