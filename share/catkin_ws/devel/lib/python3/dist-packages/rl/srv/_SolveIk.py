...
"""autogenerated by genpy from rl/SolveIkRequest.msg. Do not edit."""
import codecs
import sys
...
def _get_struct_7d():
    ...
    return _struct_7d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from rl/SolveIkResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SolveIkResponse(genpy.Message):
  _md5sum = "60cb5217e9c62c0eebb58bfe7d4bf769"
  _type = "rl/SolveIkResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """std_msgs/Float64MultiArray ik_result
bool success
...
uint32 stride  # stride of given dimension"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.ik_result is None:
        self.ik_result = std_msgs.msg.Float64MultiArray()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.ik_result.layout.dim)
      buff.write(_struct_I.pack(length))
      for val1 in self.ik_result.layout.dim:
        _x = val1.label
        length = len(_x)
      ...
      _x = self.ik_result.layout.data_offset
      buff.write(_get_struct_I().pack(_x))
      length = len(self.ik_result.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.ik_result.data))
      _x = self.success
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.ik_result.layout.dim.append(val1)
      start = end
      end += 4
      (self.ik_result.layout.data_offset,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.ik_result.data = s.unpack(str[start:end])
      start = end
      end += 1
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.ik_result.data.tostring())
      _x = self.success
      buff.write(_get_struct_B().pack(_x))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.ik_result.data = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 1
      (self.success,) = _get_struct_B().unpack(str[start:end])
      self.success = bool(self.success)
...
class SolveIk(object):
  _type          = 'rl/SolveIk'
  _md5sum = '6580254afbe9e0087fa243dc6fb4dd77'
