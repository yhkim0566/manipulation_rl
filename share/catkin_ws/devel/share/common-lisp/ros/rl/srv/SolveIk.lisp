...
(cl:defmethod cl:initialize-instance :after ((m <SolveIk-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SolveIk-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rl-srv:<SolveIk-request> is deprecated: use rl-srv:SolveIk-request instead.")))

(cl:ensure-generic-function 'end_pose-val :lambda-list '(m))
(cl:defmethod end_pose-val ((m <SolveIk-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rl-srv:end_pose-val is deprecated.  Use rl-srv:end_pose instead.")
  (end_pose m))
...
(cl:defmethod cl:initialize-instance :after ((m <SolveIk-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SolveIk-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rl-srv:<SolveIk-response> is deprecated: use rl-srv:SolveIk-response instead.")))

(cl:ensure-generic-function 'ik_result-val :lambda-list '(m))
(cl:defmethod ik_result-val ((m <SolveIk-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rl-srv:ik_result-val is deprecated.  Use rl-srv:ik_result instead.")
  (ik_result m))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SolveIk-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rl-srv:success-val is deprecated.  Use rl-srv:success instead.")
  (success m))
